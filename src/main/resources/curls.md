...
```
curl -d '{"name":"Fashion BR Inc.", "lastExecution":"2023-11-03T05:02:00", "waitingTimeInMinutes":5, "active":true}' -H "Content-Type: application/json" -X POST http://localhost:8080/report/configs
```
